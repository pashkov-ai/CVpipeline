...
- **Use Python 3.13.11** for all code
...
- **Ruff**: Linting and formatting (configured in project)
...
- Place tests in `tests/` in the subdirectory of the module being tested, ex: `eda/tests`
...
- Refer to CLAUDE.md into respective subfolders you are working on for more details
